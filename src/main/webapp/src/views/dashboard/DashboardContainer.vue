...
<template>
    <div class="px-6 pt-6 2xl:container bg-gray-50 dark:bg-gray-900">
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1">
                <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-gray-50 dark:bg-gray-900">
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-gray-50 dark:bg-gray-900">
            ...
            <div>
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-gray-50 dark:bg-gray-900">
        ...
        <div class="mt-12 flex items-center p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"
            ...
            <div>
                <span class="font-medium">Info alert!</span> This is a dummy dashboard. Go to Try Transfer / Try Delete
                payee to check the flow.
            </div>
        </div>
</div></template>